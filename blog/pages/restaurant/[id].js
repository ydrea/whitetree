  ...
  return (
    <div className={styles.grid}>
      ...
      {restaurant.data.attributes.name}   
            ...
            <p>{restaurant.data.attributes.address}</p>
      
      <img src={restaurant.data.attributes.main_img.data.attributes.name} 
      />
      {JSON.stringify(restaurant.data.attributes.main_img.data.attributes.name)} 
      </div>
  )
}
